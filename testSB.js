...
let welcomeSettings = loadData('./bot_data_test/welcome.json', {});
let goodbyeSettings = loadData('./bot_data_test/goodbye.json', {});

const defaultWelcomeMsg = '╭━━〔 🎉 𝐁𝐈𝐄𝐍𝐕𝐄𝐍𝐈𝐃𝐀 〕━━⬣\n┃ 👤 @user\n┃ ✨ ¡Bienvenido al grupo!\n┃ 📌 Lee las reglas y diviértete\n╰━━━━━━━━━━━━━━━━⬣';
const defaultGoodbyeMsg = '╭━━〔 👋 𝐃𝐄𝐒𝐏𝐄𝐃𝐈𝐃𝐀 〕━━⬣\n┃ 👤 @user\n┃ 🚀 ¡Nos vemos pronto!\n┃ 💫 Siempre serás bienvenido\n╰━━━━━━━━━━━━━━━━⬣';

function saveWelcomeConfig() { saveData('./bot_data_test/welcome.json', welcomeSettings); }
function saveGoodbyeConfig() { saveData('./bot_data_test/goodbye.json', goodbyeSettings); }
...
async function iniciarBot() {
    const { state, saveCreds } = await useMultiFileAuthState('sesion_testSB');
